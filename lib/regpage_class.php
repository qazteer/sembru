...
class RegPage extends ModulesClass{
	...
	protected function getTitle(){
		return $this->lang->getTitleReg();
	}

	protected function getMiddle(){
		$arr = $this->lang->getFormReg();
		$arr["login_border"] = "";
		$arr["name_border"] = "";
		$arr["pass_border"] = "";
	
		if($_SESSION["error_reg"]=="empty_name") {
			$arr["error_reg"] = $arr["empty"];
			$arr["login_border"] = "";
			$arr["name_border"] = "_border";
			$arr["pass_border"] = "";
			unset($_SESSION["error_reg"]);
		}
		elseif($_SESSION["error_reg"]=="empty_login") {
			$arr["error_reg"] = $arr["empty"];
		...
		return $this->getTemplate($arr, "reg");
	}
}
